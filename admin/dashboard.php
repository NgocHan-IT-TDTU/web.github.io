...
<body>
    ...
    <main class="mn-inner mt-5">
        <div class="">
                ...
                <div class="col s12 m12 col-md-4 l4">
                    <div class="card stats-card border-0 shadow bg-dark ">
                        <div class="card-content">
                            <span class="card-title text-white">Total Regd leave</span>
            ...
            <div class="card stats-card border-0 shadow bg-dark">
                <div class="card-content">
                    <span class="card-title text-white">Total Employee</span>
                        <?php
                            $sql = "SELECT id from  tblemployees";
                            $query = $dbh -> prepare($sql);
                            $query->execute();
                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                            $employeepcount=$query->rowCount();
                        ?>   
                        <span class="stats-counter text-white"><span class="counter"><?php echo htmlentities($employeepcount);?></span></span>
