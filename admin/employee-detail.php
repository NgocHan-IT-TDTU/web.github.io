...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from tbemployees WHERE id=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{         
  ...
  <tr>
                                            ...
                                            <td><?php echo htmlentities($result->Department);?></td>
                                             <td style="font-size:16px;"><b>City :</b></td>
                                            <td>From <?php echo htmlentities($result->City);?> to <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>Country</b></td>
                                           <td><?php echo htmlentities($result->Country);?></td>
                                        </tr>

<tr>
                                            <td style="font-size:16px;"><b>Number leaves</b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Numberleaves);?></td>
