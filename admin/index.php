...
<nav class="navbar navbar-expand-lg navbar-light py-3">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center align-items-center" id="navbarNavAltMarkup">
            <div class="navbar-nav d-flex justify-content-center align-items-center">
                ...
                <div class="navbar-nav d-flex justify-content-center align-items-center">
                    <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
                    <a class="nav-item text-warning font-weight-bold nav-link ml-3 btn btn-info" href="#">Admin Login</a>
                </div>
                <div class="navbar-nav d-flex justify-content-center align-items-center">
                        <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
                    <a class="nav-item text-warning font-weight-bold nav-link ml-3 btn btn-info" href="../index.php">Employee Login</a>
            ...
            <main class="mn-inner mt-5">
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="logo">
                        <a href="/"><img id="logo" src="../images/jojo FINAL.png" alt=""></a>
                    </div>
                    <h4 class="font-weight-bold text-center text-danger">Welcome to Jojo company</h4>
