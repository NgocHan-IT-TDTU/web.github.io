            ...
            <header class="mn-header navbar-fixed">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 " >
                    <div class="nav-wrapper row">
                        <!-- thêm style này vào file css-->
                        <marquee width="950px" direction="left" behavior="alternate" ><span clas="title-header"style="font-size:38px; width=''font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Jojo's Management System</span>
