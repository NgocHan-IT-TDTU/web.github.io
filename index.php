...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Jojo Company | Home Page</title>
    ...
    <body>
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            <a class="nav-item text-warning font-weight-bold nav-link ml-3 btn btn-info" href="admin/">Admin Login</a>
          ...
          <!--   <a class="nav-item text-white font-weight-bold nav-link active ml-3" href="#">Home <span class="sr-only">(current)</span></a> -->
            ...
            <main class="mn-inner mt-5">
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="logo">
                        <a href="/"><img id="logo" src="all_images/jojo FINAL.png" alt=""></a>
                    </div>
